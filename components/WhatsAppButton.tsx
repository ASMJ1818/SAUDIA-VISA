...
const WhatsAppButton: React.FC = () => {
  // Replace with the actual phone number including the country code without '+' or '00'
  const phoneNumber = '962700000000'; 
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-transform transform hover:scale-110"
